...
function spellCheck() {
    ...
    if (textEntered == originText) {
        ...
        testWrapper.style.borderColor = "#5F875F"; //Green
    } else {
        if (textEntered == originTextMatch) {
            testWrapper.style.borderColor = "#5F87AF"; //Blue
        } else {
            errors++;
            if (!(event.keyCode === 8)) {
              testWrapper.style.borderColor = "#FF8700"; //Orange
            } else {
              errors--;
            }
        }
...
function reset() {
    ...
    testWrapper.style.borderColor = "#6C6C6C";
